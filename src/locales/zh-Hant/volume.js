export default {
  ...
  'volume.hint.create.success': '成功創建 volume 。',
  'volume.hint.create.failure': '創建 volume 失敗。',
  'volume.hint.delete.success': '成功刪除 volume 。',
  'volume.hint.delete.failure': '刪除 volume 失敗。'
}
